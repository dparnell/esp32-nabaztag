...
{
  // read the value of ADC1 - GPIO36
  adc1_config_width(ADC_WIDTH_12Bit);
  adc1_config_channel_atten(ADC1_CHANNEL_0,ADC_ATTEN_0db);
  return adc1_get_raw(ADC1_CHANNEL_0) >> 4;
}
...
void init_vlsi(void)
{
  ...
  putst_uart("init_vlsi: Set VS1003_CLOCKF\n");
  ...
  putst_uart("init_vlsi: fast SPI\n");
  FastSPI();

  putst_uart("init_vlsi: Set VS1003_MODE\n");
  //Config MODE
  vlsi_write_sci(VS1003_MODE,(VS1003_MODE_VALUE_H<<8)|VS1003_MODE_VALUE_L | SM_RESET);

  //Config VOLUME
  putst_uart("init_vlsi: Set VS1003_VOLUME\n");
