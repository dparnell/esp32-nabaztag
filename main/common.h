...
#define INT_AUDIO_BIT BIT_0
#define INT_AUDIO_PIN GPIO_NUM_14
#define INT_AUDIO_AS_OUTPUT gpio_set_direction(INT_AUDIO_PIN, GPIO_MODE_OUTPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[INT_AUDIO_PIN], PIN_FUNC_GPIO);
#define INT_AUDIO_AS_INPUT gpio_set_direction(INT_AUDIO_PIN, GPIO_MODE_INPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[INT_AUDIO_PIN], PIN_FUNC_GPIO);
#define INT_AUDIO_SET      gpio_set_level(INT_AUDIO_PIN, 1)
#define INT_AUDIO_CLEAR    gpio_set_level(INT_AUDIO_PIN, 0)
#define INT_AUDIO_READ     gpio_get_level(INT_AUDIO_PIN)

#define CS_AUDIO_AMP_BIT BIT_0
#define CS_AUDIO_AMP_AS_OUTPUT
#define CS_AUDIO_AMP_AS_INPUT
#define CS_AUDIO_AMP_SET
#define CS_AUDIO_AMP_CLEAR
#define CS_AUDIO_AMP_READ     0

#define CS_AUDIO_SCI_BIT BIT_0
#define CS_AUDIO_SCI_PIN GPIO_NUM_13
#define CS_AUDIO_SCI_AS_OUTPUT gpio_set_direction(CS_AUDIO_SCI_PIN, GPIO_MODE_OUTPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[CS_AUDIO_SCI_PIN], PIN_FUNC_GPIO);
#define CS_AUDIO_SCI_AS_INPUT gpio_set_direction(CS_AUDIO_SCI_PIN, GPIO_MODE_INPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[CS_AUDIO_SCI_PIN], PIN_FUNC_GPIO);
#define CS_AUDIO_SCI_SET      gpio_set_level(CS_AUDIO_SCI_PIN, 1)
#define CS_AUDIO_SCI_CLEAR    gpio_set_level(CS_AUDIO_SCI_PIN, 0)
#define CS_AUDIO_SCI_READ     gpio_get_level(CS_AUDIO_SCI_PIN)

#define CS_AUDIO_SDI_BIT BIT_0
#define CS_AUDIO_SDI_PIN GPIO_NUM_12
#define CS_AUDIO_SDI_AS_OUTPUT gpio_set_direction(CS_AUDIO_SDI_PIN, GPIO_MODE_OUTPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[CS_AUDIO_SDI_PIN], PIN_FUNC_GPIO);
#define CS_AUDIO_SDI_AS_INPUT gpio_set_direction(CS_AUDIO_SDI_PIN, GPIO_MODE_INPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[CS_AUDIO_SDI_PIN], PIN_FUNC_GPIO);
#define CS_AUDIO_SDI_SET      gpio_set_level(CS_AUDIO_SDI_PIN, 1)
#define CS_AUDIO_SDI_CLEAR    gpio_set_level(CS_AUDIO_SDI_PIN, 0)
#define CS_AUDIO_SDI_READ     gpio_get_level(CS_AUDIO_SDI_PIN)

#define RST_AUDIO_BIT BIT_0
#define RST_AUDIO_PIN GPIO_NUM_27
#define RST_AUDIO_AS_OUTPUT gpio_set_direction(RST_AUDIO_PIN, GPIO_MODE_OUTPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[RST_AUDIO_PIN], PIN_FUNC_GPIO);
#define RST_AUDIO_AS_INPUT gpio_set_direction(RST_AUDIO_PIN, GPIO_MODE_INPUT); PIN_FUNC_SELECT(GPIO_PIN_MUX_REG[RST_AUDIO_PIN], PIN_FUNC_GPIO);
#define RST_AUDIO_SET      gpio_set_level(RST_AUDIO_PIN, 1)
#define RST_AUDIO_CLEAR    gpio_set_level(RST_AUDIO_PIN, 0)
#define RST_AUDIO_READ     gpio_get_level(RST_AUDIO_PIN)

#elif PCB_RELEASE == LLC2_4c
