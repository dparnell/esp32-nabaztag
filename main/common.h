...
#define INT_AUDIO_AS_OUTPUT gpio_set_direction(INT_AUDIO_PIN, GPIO_MODE_OUTPUT)
#define INT_AUDIO_AS_INPUT gpio_set_direction(INT_AUDIO_PIN, GPIO_MODE_INPUT)
...
#define CS_AUDIO_SCI_AS_OUTPUT gpio_set_direction(CS_AUDIO_SCI_PIN, GPIO_MODE_OUTPUT)
#define CS_AUDIO_SCI_AS_INPUT gpio_set_direction(CS_AUDIO_SCI_PIN, GPIO_MODE_INPUT)
...
#define CS_AUDIO_SDI_AS_OUTPUT gpio_set_direction(CS_AUDIO_SDI_PIN, GPIO_MODE_OUTPUT)
#define CS_AUDIO_SDI_AS_INPUT gpio_set_direction(CS_AUDIO_SDI_PIN, GPIO_MODE_INPUT)
...
#define RST_AUDIO_AS_OUTPUT gpio_set_direction(RST_AUDIO_PIN, GPIO_MODE_OUTPUT)
#define RST_AUDIO_AS_INPUT gpio_set_direction(RST_AUDIO_PIN, GPIO_MODE_INPUT)
